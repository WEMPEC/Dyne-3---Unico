...
public class TabAbs implements ChangeListener {
  ...
  public TabAbs(JPanel panel, GridBagLayout gl_panel, JPanel panel1, GridBagLayout gl_panel1,
    ...
    spinner_6.setModel(new SpinnerNumberModel(new Integer(6000), null, null, new Integer(1)));
    ...
    spinner_7.setModel(new SpinnerNumberModel(new Integer(7000), null, null, new Integer(1)));
    ...
    // if (checkload) {
    // System.out.println("action listefffffffffffffffffffffffffffffffner of abs is true");
    // for (int i = 0; i < 6; ++i) {
    // tempsent[i] = loadinfo.getSentVal()[i];
    ...
    // .setModel(new SpinnerNumberModel(new Integer(tempsent[2]), null, null, new Integer(1)));
    //
    // spinner_2.setFont(new Font("Times New Roman", Font.BOLD, 17));
    // panel_1.add(spinner_2, gbc_spinner_2);
    // // spinner_2
    // // .setModel(new SpinnerNumberModel(new Integer(tempsent[2]), null, null, new Integer(1)));
    // spinner_2.setValue(new Integer(tempsent[2]));
    //
    // spinner_2.addChangeListener(new ChangeListener() {
    //
    // @Override
    ...
    spinner_8.setModel(new SpinnerNumberModel(new Long(8000), null, null, new Long(1)));
    ...
    if (checkload) { JTextField check = new JTextField("Not loading");
    check.setFont(new Font("Times New Roman", Font.BOLD, 17));
    GridBagConstraints gbc_check = new GridBagConstraints();
    gbc_check.insets = new Insets(0, 0, 0, 0);
   // gbc_check.anchor = GridBagConstraints.EAST;
    gbc_check.gridx = 1;
    gbc_check.gridy = 13;
    panel_1.add(check, gbc_check);
 
    if (checkload) {
      System.out.println("check in tabs abs is true, value is " + tempsent[2]);
      int temp2 = tempsent[2];
    ...
    check.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        System.out.println("value in check" + tempsent [2]);
        System.out.print("button refresh is not active");
       if (checkload) { 
         check.setText("Load is ready");
         spinner.setModel(
            new SpinnerNumberModel(new Integer(1900), new Integer(0), null, new Integer(1)));
       System.out.print("button refresh is active");
        spinner.setEditor(new JSpinner.NumberEditor(spinner, "00000"));}
        // if (checkload) {
        //
        // spinner.setModel(new SpinnerNumberModel(new Integer(tempsent[2]), new Integer(0), null,
        // new Integer(1)));
        // System.out.println("value " + tempsent[2]);
        // spinner.setEditor(new JSpinner.NumberEditor(spinner, "00000"));
        //
      }
    });
  ...
  /**
   * @param spinner_2 the spinner_2 to set
   */
  public void setSpinner() {
    spinner_2
        .setModel(new SpinnerNumberModel(new Integer(1900), new Integer(0), null, new Integer(1)));

    spinner_2.setEditor(new JSpinner.NumberEditor(spinner_2, "00000"));
